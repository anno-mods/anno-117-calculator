...
<h5>作者</h5>
<p>Nico Höllerich</p> <p>hoellerich.nico@freenet.de</p><br/> <h5>錯誤回報與改進建議</h5> <span>如果您遇到任何錯誤或不便之處，或想建議改進，請在 GitHub 上建立 Issue（</span><a href="https://github.com/NiHoel/Anno1800Calculator/issues">https://github.com/NiHoel/Anno1800Calculator/issues</a><span>）</span>`
    }
};
